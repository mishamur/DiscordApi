...
2. в текстовом канале вашег сервера в дискорде напишите //getwr НикРусскоязычногоИгрока, для вас -getwr НикРусскоязычногоИгрока (точно не помню, посмотрите в классе Program   StringPrefixes = new[] { "//" } );
Рекомендуемые никнеймы: FamichOcelotov, neadecvatt228, W3akLink, NiNjAZz
или можете посмотреть здесь, фильтр "Россия" https://game-tournaments.com/lol/player?country=3
